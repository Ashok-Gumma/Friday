...
import { NotionLoginArt } from "./NotionArt.jsx";
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ padding: "10px 0" }}>
            <NotionLoginArt width={220} height={220} />
          </div>
          ...
          <p style={{ fontSize: "0.85rem", color: "var(--text-muted)", maxWidth: "260px", lineHeight: 1.5 }}>
            Pick up right where you left off. Your AI companion is ready.
          </p>
        </div>
        ...
        <div style={{ padding: "40px 36px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", marginBottom: "20px" }}>
            <GoogleLogin onSuccess={handleGoogleSuccess} onError={() => setError("Google Sign-In failed")} shape="rectangular" />
          </div>
